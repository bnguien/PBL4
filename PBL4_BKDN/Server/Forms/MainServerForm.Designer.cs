namespace Server.Forms
{
    partial class MainServerForm
    {
		...
		private void InitializeComponent()
		{
			...
			ctxClients.Items.AddRange(new ToolStripItem[] { systemInfoToolStripMenuItem, remoteShellToolStripMenuItem, fileManagerToolStripMenuItem, taskManagerToolStripMenuItem });
			ctxClients.Name = "ctxClients";
			ctxClients.Size = new Size(167, 76);
			// 
			...
			systemInfoToolStripMenuItem.Size = new Size(166, 24);
			...
			remoteShellToolStripMenuItem.Size = new Size(166, 24);
			...
			fileManagerToolStripMenuItem.Size = new Size(166, 24);
