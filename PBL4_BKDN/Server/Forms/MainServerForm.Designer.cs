...
namespace Server.Forms
{
    partial class MainServerForm
    {
		...
		private void InitializeComponent()
		{
			...
			topPanel.Size = new Size(1000, 54);
			topPanel.TabIndex = 0;
			// 
			// btnChangePort
			// 
			...
			splitContainer.Location = new Point(0, 54);
			...
			dgvClients.Size = new Size(555, 546);
			dgvClients.TabIndex = 0;
			// 
			// ctxClients
			// 
			ctxClients.ImageScalingSize = new Size(20, 20);
			ctxClients.Items.AddRange(new ToolStripItem[] { systemInfoToolStripMenuItem, remoteShellToolStripMenuItem, messageBoxToolStripMenuItem, fileManagerToolStripMenuItem, taskManagerToolStripMenuItem, screenControlToolStripMenuItem, keyLoggerToolStripMenuItem, shutdownActionToolStripMenuItem, userManagementToolStripMenuItem });
			ctxClients.Name = "ctxClients";
			ctxClients.Size = new Size(200, 220);
			// 
			...
			systemInfoToolStripMenuItem.Size = new Size(199, 24);
			...
			remoteShellToolStripMenuItem.Size = new Size(199, 24);
			...
			messageBoxToolStripMenuItem.Size = new Size(199, 24);
			...
			fileManagerToolStripMenuItem.Size = new Size(199, 24);
			...
			taskManagerToolStripMenuItem.Size = new Size(199, 24);
			...
			screenControlToolStripMenuItem.Size = new Size(199, 24);
			...
			keyLoggerToolStripMenuItem.Size = new Size(199, 24);
			...
			keyLoggerStartParallelToolStripMenuItem.Size = new Size(211, 26);
			...
			keyLoggerStartContinuousToolStripMenuItem.Size = new Size(211, 26);
			...
			shutdownActionToolStripMenuItem.Size = new Size(199, 24);
			...
			userManagementToolStripMenuItem.Size = new Size(199, 24);
			...
			elevateToolStripMenuItem.Size = new Size(245, 26);
			...
			disconnectToolStripMenuItem.Size = new Size(245, 26);
			...
			rightPanel.Size = new Size(441, 546);
